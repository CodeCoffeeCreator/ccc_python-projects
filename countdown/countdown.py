...
# clock
Label(root, font="arial 15 bold", text="Current Time:   ", bg="papaya whip").place(x=55, y=70)
...
button = Button(
    root, text="Start", bg="#ea3548", bd=0, fg="#fff", width=20, height=2, font="arial 10 bold", command=Timer
)
